...
| productDescription  | string | Optional | The description of the product. Required on product pages.                                                                |
...
| productDescription | string | Optional | The description of the product. Required on product pages.                                                                |
| test               | bool   | Optional | If set to `true`, interactions with this widget will not be included in analytics.                                        |
| locale             | string | Optional | The language of the QA Widget Entrypoint. For example, `en` or `ar`.                                                      |
| storeType          | string | Optional | If the value is `playground`, this store will be a playground store.                                                      |
| storeIndustry      | string | Optional | Provide industry context for playground stores. Required if `storeType` is `playground`. Possible values: `skincare`.     |
...
const MyComponent = () => (
    <Highlights shop="my-shop.com" productTitle="My Product" productDescription="Product description here" />
)
```
...
| preview            | bool   | Optional | Enables design preview mode.                                                                                              |
| locale             | string | Optional | The language of the Highlights. For example, `en` or `ar`.                                                                |
| test               | bool   | Optional | If set to `true`, interactions with this widget will not be included in analytics.                                        |
| storeType          | string | Optional | If the value is `playground`, this store will be a playground store.                                                      |
| storeIndustry      | string | Optional | Provide industry context for playground stores. Required if `storeType` is `playground`. Possible values: `skincare`.     |
...
| locale        | string | Optional | The language of the SmartMenu. For example, `en` or `ar`.                                                                 |
| test          | bool   | Optional | If set to `true`, interactions with this widget will not be included in analytics.                                        |
| storeType     | string | Optional | If the value is `playground`, this store will be a playground store.                                                      |
| storeIndustry | string | Optional | Provide industry context for playground stores. Required if `storeType` is `playground`. Possible values: `skincare`.     |
...
An AI-driven customer assistance widget that provides personalized shopping guidance.

#### Usage

```jsx
import { ShopConcierge } from '@gigit-ai/gigit-apps'

const MyComponent = () => <ShopConcierge shop="my-shop.com" />
```
...
```jsx
import dynamic from 'next/dynamic'
const ShopConcierge = dynamic(
    () => import('@gigit-ai/gigit-apps').then((module) => module.ShopConcierge),
    {
        ssr: false,
    }
)
...
| shop          | string | ✅       | The domain of your store URL (e.g., `my-shop.com`).                                                                       |
| pageType      | string | Optional | Page type: `index`, `product` or `collection`.                                                                            |
| locale        | string | Optional | The language of the Shop Concierge. For example, `en` or `ar`.                                                            |
| test          | bool   | Optional | If set to `true`, interactions with this widget will not be included in analytics.                                        |
| storeType     | string | Optional | If the value is `playground`, this store will be a playground store.                                                      |
| storeIndustry | string | Optional | Provide industry context for playground stores. Required if `storeType` is `playground`. Possible values: `skincare`.     |
